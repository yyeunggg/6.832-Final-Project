...
def PID(roll, pitch, yaw, f):
	#Define the global variables to prevent them from dying and resetting to zero, 
	#each time a function call occurs. Some of these variables may be redundant.
	...
	#-----------------------
	#Assign your PID values here. From symmetry, control for roll and pitch is 
	#the same.
	kp_roll = 70
	ki_roll = 0.0002
	kd_roll = 89
	...
	#if it is sampled at regular intervals. You can change the sampleTime to 
	#whatever value is suitable for your plant.
	if(dTime >= sampleTime):
		#Kp*e(t)
	...
	#algorithm goes crazy and high af.
